package com.example.mindmingle.controller;// Copyright 2024 Google LLC
//
...
public class MeetQuickstartController {
  /**
  ...
  private static UserAuthorizer getAuthorizer(URI callbackUri) throws IOException {
    // Load client secrets.
    try (InputStream in = MeetQuickstartController.class.getResourceAsStream(CREDENTIALS_FILE_PATH)) {
      if (in == null) {
